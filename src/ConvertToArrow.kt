...
class ConvertToArrow : AnAction("Convert to arrow function") {
    ...
    override fun actionPerformed(event: AnActionEvent) {
        ...
        while (psiElement != null && (!psiElement.text.startsWith("function") || psiElement.text == "function")) {
            psiElement = psiElement.parent
        }

        if (psiElement != null) {
            var text = psiElement.text
            text = text.replaceFirst("function".toRegex(), "")

            if (text.trim { it <= ' ' }.startsWith("(")) {
